...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"Timetable","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 138:
/*!*******************************************************************************************************************************!*\
  !*** C:/Users/Syne/source/repos/Timetable/Timetable.Web.AppClient/Timetable/uni_modules/mp-html/components/mp-html/parser.js ***!
  \*******************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!***************************************************************************************************!*\
  !*** C:/Users/Syne/source/repos/Timetable/Timetable.Web.AppClient/Timetable/commonjs/map_util.js ***!
  \***************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.baiduMapApi = exports.aMapApi = exports.tencentMapApi = void 0;
...
var _GPS = _interopRequireDefault(__webpack_require__(/*! ./GPS.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}String.format = function () {var s = arguments[0];for (var i = 0; i < arguments.length - 1; i++) {var reg = new RegExp("\\{" + i + "\\}", "gm");s = s.replace(reg, arguments[i + 1]);}return s;};
...
function MapAPI(key, options) {
      ...
      success: function success(res) {
        ...
        if (res.data.result && res.data.result.pois) {
          ...
          if (options.mapName == "aMap" || options.mapName == "baiduMap") {
            res.data.result.pois = pois.sort(function (a, b) {
  ...
  this.getDistance = function (fromPoint, toPoints, callback) {
    if (options.mapName == "baiduMap") {
      ...
      var toArr = [];
      var toStr;
      toArr = toPoints.map(function (item) {
  ...
  function baiduMapGetDistance(fromPoint, toPoints) {
    ...
    toPoints.forEach(function (item) {

      elements.push({ distance: _GPS.default.distance(fromPoint, item.location).toFixed(0) });
    });
    return res;
  }
}
...
var tencentMapApi = new MapAPI(mapKey.tencentMap, {
  ...
  "poiurl": "https://apis.map.qq.com/ws/geocoder/v1/?get_poi=1&location={0}&poi_options=address_format=short;radius=400;page_size=20;page_index=1;policy=2&key={1}" });exports.tencentMapApi = tencentMapApi;
...
var aMapApi = new MapAPI(mapKey.aMap, {
  ...
  "poiurl": "https://restapi.amap.com/v3/geocode/regeo?homeorcorp=0&location={0}&radius=400&extensions=all&key={1}" });exports.aMapApi = aMapApi;
...
var baiduMapApi = new MapAPI(mapKey.baiduMap, {
  ...
  poiurl: 'https://api.map.baidu.com/reverse_geocoding/v3/?coordtype=gcj02ll&ret_coordtype=gcj02ll&location={0}&radius=1000&extensions_poi=1&output=json&ak={1}' });exports.baiduMapApi = baiduMapApi;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 15:
/*!**********************************************************************************************!*\
  !*** C:/Users/Syne/source/repos/Timetable/Timetable.Web.AppClient/Timetable/commonjs/GPS.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  delta: function delta(lat, lon) {
    ...
    var dLat = dLat * 180.0 / (a * (1 - ee) / (magic * sqrtMagic) * this.PI);
    var dLon = dLon * 180.0 / (a / sqrtMagic * Math.cos(radLat) * this.PI);
    return { 'lat': dLat, 'lng': dLon };
  },
  //GCJ-02 to BD-09
  bd_encrypt: function bd_encrypt(_ref) {var lat = _ref.lat,lng = _ref.lng;
    var x = lng,y = lat;
  ...
  //BD-09 to GCJ-02
  bd_decrypt: function bd_decrypt(_ref2) {var lat = _ref2.lat,lng = _ref2.lng;
  ...
  distance: function distance(pointA, pointB) {
    ...
    var earthR = 6371000.;
    var x = Math.cos(pointA.lat * this.PI / 180.) * Math.cos(pointB.lat * this.PI / 180.) * Math.cos((pointA.lng - pointB.lng) * this.PI / 180);
    var y = Math.sin(pointA.lat * this.PI / 180.) * Math.sin(pointB.lat * this.PI / 180.);
    var s = x + y;
    if (s > 1) s = 1;
    if (s < -1) s = -1;
...
/***/ 16:
/*!***********************************************************************************************!*\
  !*** C:/Users/Syne/source/repos/Timetable/Timetable.Web.AppClient/Timetable/commonjs/auth.js ***!
  \***********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _store = _interopRequireDefault(__webpack_require__(/*! ../store/store.js */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
console.log("auth.js加载");var _default =
{
  baseurl: _store.default.state.baseUrl,
  afterLoginFN: undefined,
  /**
                            * 登录后执行
                            * @param {Function} fn 登录完毕后的回调函数，注意同一时间程序只能有一个登录回调函数
                            */
  afterLogin: function afterLogin(fn) {var _this = this;
    this.afterLoginFN = fn;
    this.ifLogin({
      yes: function yes() {
        _this.afterLoginFN();
        _this.afterLoginFN = undefined; //执行完后，重置为undefined，避免多次执行
      },
      no: function no() {
        _this.login();
      } });
  ...
  /**
      ...
      */
  login: function login(onlyTry) {var _this2 = this;
    uni.getSetting({
        ...
        if (e.authSetting["scope.userInfo"]) {
          uni.login({
            success: function success(res) {
              ...
              uni.request({
                url: _this2.baseurl + "/api/login/LoginByWeChatCode",
                method: "GET",
                data: {
                  code: res.code },

                success: function success(serverRes) {
                  if (serverRes.data.success) {
                    ...
                    _this2.getUserInfo();
                    if (typeof _this2.afterLoginFN == "function") {
                      _this2.afterLoginFN();
                      _this2.afterLoginFN = undefined; //执行完后，重置为undefined，避免多次执行
                    }
  ...
  getUserInfo: function getUserInfo() {
    uni.request({
      ...
      success: function success(res) {
        ...
        _store.default.commit('set_userInfo', res.data.data);
      } });
  ...
  /**
      ...
      */
  ifLogin: function ifLogin(options) {
...
/***/ 5:
/*!*****************************************************************************************!*\
  !*** C:/Users/Syne/source/repos/Timetable/Timetable.Web.AppClient/Timetable/pages.json ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 9:
/*!*********************************************************************************************!*\
  !*** C:/Users/Syne/source/repos/Timetable/Timetable.Web.AppClient/Timetable/store/store.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    configBaseUrl: function configBaseUrl(state, baseUrl) {
      state.baseUrl = baseUrl;
    },
    set_location: function set_location(state, value) {
